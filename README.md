...
**NOTE: YOU SHOULD NOT DRIVE LARGE LOADS DIRECTLY FROM THE PWM OUTPUTS OF THE PCA9685. The PCA9685 output drivers can sink up to 25 mA at 5 V and are intended for direct driving of LEDs or a transistor to switch a larger load.  ** 
